...
public class JobPosting {
	...
	public String toString() {
		return "JobPosting [jobNumber=" + jobNumber + ", managerFirst="
				+ managerFirst + ", managerLast=" + managerLast
				+ ", recruiterFirst=" + recruiterFirst + ", recruiterLast="
				+ recruiterLast + ", contactEmail=" + contactEmail
				+ ", postingDate=" + postingDate + ", empStatus=" + empStatus
				+ ", bonusAvail=" + bonusAvail + ", bonusAmt=" + bonusAmt
				+ ", jobLevel=" + jobLevel + ", jobSchedule=" + jobSchedule
				+ ", jobShift=" + jobShift + ", jobType=" + jobType
				+ ", overTime=" + overTime + ", willTravel=" + willTravel
				+ ", jobField=" + jobField + ", jobFieldSub=" + jobFieldSub
				+ ", organization=" + organization + ", level1=" + level1
				+ ", level2=" + level2 + ", level3=" + level3 + ", level4="
				+ level4 + ", level5=" + level5 + ", level5Zip=" + level5Zip
				+ ", otherLevel1=" + otherLevel1 + ", otherLevel2="
				+ otherLevel2 + ", otherLevel3=" + otherLevel3
				+ ", otherLevel4=" + otherLevel4 + ", otherLevel5="
				+ otherLevel5 + ", otherLevel5Zip=" + otherLevel5Zip
				+ ", titleEng=" + titleEng + ", titleFr=" + titleFr
				+ ", descEng=" + descEng + ", descFr=" + descFr
				+ ", qualificationEng=" + qualificationEng
				+ ", qualificationFr=" + qualificationFr + ", applyUrl="
				+ applyUrl + ", referralUrl=" + referralUrl + "]";
	}		
}
